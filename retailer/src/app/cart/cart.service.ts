...
export class CartService {
  ...
  postOrderAgreement(data: FormData) {
    return this.httpClient.post(this.nodejsApi + '/payment-retail/orderAgreement', data);
  }


  postCheckCargoPrice(data: FormData) {
    return this.httpClient.post(this.nodejsApi + '/cargoPrice/postCheckCargoPrice', data);
  }

  postCheckCampaign(data: FormData) {

    return this.httpClient.post(this.nodejsApi + '/newsletter/' + 'postCheckCampaign', data);
  }
