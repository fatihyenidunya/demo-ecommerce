...
export class GeneralService {
  ...
  postSecondImage(data: FormData, header) {

    return this.httpClient.post(this.nodejsApi + '/' + this.moduleName + '/' + 'postsecondimage', data, { headers: { 'Authorization': 'Bearer ' + header } });
  }
